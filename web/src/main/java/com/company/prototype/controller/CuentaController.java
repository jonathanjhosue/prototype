...
public class CuentaController implements Serializable {
	...
	@EJB
    private com.company.prototype.service.CuentaFacade ejbFacade;
    ...
    protected void setEmbeddableKeys() {
        selected.getCuentaPK().setEntidadId(selected.getEntidad().getId());
    }

    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new com.company.prototype.model.entity.CuentaPK());
    }
    ...
    public Cuenta getCuenta(com.company.prototype.model.entity.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        com.company.prototype.model.entity.CuentaPK getKey(String value) {
            com.company.prototype.model.entity.CuentaPK key;
        ...
        String getStringKey(com.company.prototype.model.entity.CuentaPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getNumero());
            sb.append(SEPARATOR);
            sb.append(value.getEntidadId());
            return sb.toString();
        }
